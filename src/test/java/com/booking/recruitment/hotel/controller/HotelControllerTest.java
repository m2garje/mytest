...
class HotelControllerTest {
  ...
  void hotelCreatedCorrectly() throws Exception {
    ...
    Hotel newHotel = Hotel.builder().setName("This is a test hotel").setCity(city)
    .setAddress("Weesperbuurt en Plantage")
    .setRating(9.2)
    .setLatitude(52.364799)
    .setLongitude(4.908971).build();
    Long newHotelId =
        mapper
            .readValue(
                mockMvc
